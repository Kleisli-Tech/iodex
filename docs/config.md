...
# Valid values for wire_api are "chat", "responses", and "anthropic-messages". Defaults to "chat" if omitted.
wire_api = "chat"
...
| `model_providers.<id>.wire_api`                  | `chat` \| `responses` \| `anthropic-messages`                     | Protocol used (default: `chat`).                                                                                                |
